...
assert.doesNotMatch(renderStatusSvg(warning), /[\u4e00-\u9fff]/);
...
assert.match(renderStatusSvg(normal), /data-icon="shield"/);
assert.match(renderStatusSvg(warning), /data-icon="warning"/);
assert.match(renderStatusSvg(normal), /M50 32L68 40/);
